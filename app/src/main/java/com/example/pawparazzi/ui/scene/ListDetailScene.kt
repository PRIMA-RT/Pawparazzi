...
import com.example.pawparazzi.ui.scene.ListDetailScene.Companion.LIST_KEY
...
fun <T : Any> rememberListDetailSceneStrategy(): ListDetailSceneStrategy<T> {
    ...
    return remember(isAtLeastMedium) {
        ListDetailSceneStrategy(isAtLeastMedium)
    }
}
 ...
 */
class ListDetailSceneStrategy<T : Any>(val isWindowMedium: Boolean) : SceneStrategy<T> {
